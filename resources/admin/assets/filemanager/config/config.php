...
// $upload_dir 		= "/".$GLOBALS['upload_dir']; // path from base_url to base of upload folder (with start and final /)
// $current_path 		= '../../'.$GLOBALS['upload_dir']; // relative path from filemanager folder to upload folder (with final /)
// $thumbs_base_path 	= '../../'.$GLOBALS['thumbs_folder']; // relative path from filemanager folder to thumbs folder (with final /)

$base_url			= $url;  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir 		= "/resources/assets/uploads/others/"; // path from base_url to base of upload folder (with start and final /)
$current_path 		= "../../../assets/uploads/others/"; // relative path from filemanager folder to upload folder (with final /)
$thumbs_base_path 	= "../../../assets/uploads/thumbs/";; // relative path from filemanager folder to thumbs folder (with final /)
//--------------------------------------------------------------------------------------------------------
