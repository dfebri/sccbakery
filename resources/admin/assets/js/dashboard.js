/* [ ---- dashboard Admin - dashboard ---- ] */
    ...
    $(document).ready(function() {
        //* todo list
        dashboard_todoList.init();
        //* pageviews chart
        dashboard_charts.pages();
        //* sales chart
        dashboard_charts.sales();
        //* users chart
        dashboard_charts.users();
        //* small gallery grid
        dashboard_gal_grid.small();
        //* responsive carousel
        dashboard_rcarousel.init();
        //* chat
        dashboard_chat.init();
        //* calendar
        dashboard_calendar.widget();
    });
    ...
    dashboard_todoList = {
        init: function() {
            if($('.todo-list').length) {
                dashboard_todoList.checkCompleted();
                dashboard_todoList.completeTask();
                dashboard_todoList.dragTasks();
                dashboard_todoList.countTasks();
                dashboard_todoList.countAll();
            }
        },
