                        ...
                        <div id="userinteract">
                            ...
                            <div class="tab" id="tab-4">
                                <div class="form-group clearfix">
                                    <label class="col-sm-2 control-label">Google Analytics Code</label>
                                    <div class="col-sm-5">
                                        {!! Form::text('ga_code', $edit_data->ga_code, array('class'=>'form-control', 'placeholder'=>'Insert your GA Code here')) !!}
                                    </div>
                                </div>
                            </div>
