						...
						{!! Form::open(array('files'=>true, 'id'=>'form-scaffold'), 'POST') !!}
                            <div class="tab" id="tab-4">
								<div class="form-group clearfix">
									<label class="col-sm-2 control-label">Bakeware&Co Link</label>
									<div class="col-sm-5">
										{!! Form::text('bakeware_link', $edit_data->bakeware_link, array('class'=>'form-control', 'placeholder'=>'')) !!}
										<div class="form-suffix clearfix">without http://</div>
									</div>
								</div>
                            </div>
